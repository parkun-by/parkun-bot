...
class Locator():
    ...
    @classmethod
    async def get_boundary(cls, http_session, region_name):
    ...
    async def download_boundaries(self):
        self._boundaries = {
            config.MINSK:
                await self.get_boundary(self._http_session,
                                        'Minsk, Belarus'),
    ...
    def __point_is_in_polygon(self, boundary, latitude, longitude):
        i = 0
        overlap = False
